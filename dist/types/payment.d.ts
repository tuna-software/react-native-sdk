...
export type ApplePaySupportedNetwork = 'visa' | 'mastercard' | 'amex' | 'discover' | 'elo' | 'hipercard';
...
export type GooglePaySupportedNetwork = 'VISA' | 'MASTERCARD' | 'AMEX' | 'DISCOVER' | 'JCB';
...
export type PaymentStatus = 'pending' | 'processing' | 'authorized' | 'captured' | 'success' | 'failed' | 'cancelled' | 'expired' | 'refunded';
