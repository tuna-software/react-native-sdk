...
var reactNativePayments = require('@rnw-community/react-native-payments');
...
class AntifraudManager {
  ...
  async collectDeviceData() {
    try {
      ...
      const deviceData = {
        ...
        platformVersion: reactNative.Platform.Version.toString(),
        ...
        systemName: DeviceInfo ? await DeviceInfo.getSystemName() : reactNative.Platform.OS,
        systemVersion: DeviceInfo ? await DeviceInfo.getSystemVersion() : reactNative.Platform.Version.toString(),
        // Network information
        ...
        ...(reactNative.Platform.OS !== 'web' && DeviceInfo && {
          carrier: await DeviceInfo.getCarrier()
        }),
        // iOS specific
        ...(reactNative.Platform.OS === 'ios' && DeviceInfo && {
          iosIdForVendor: await DeviceInfo.getIosIdForVendor()
        }),
        // Android specific
        ...(reactNative.Platform.OS === 'android' && DeviceInfo && {
  ...
  generateFallbackDeviceId() {
    ...
    return `${reactNative.Platform.OS}-${timestamp}-${random}`;
  }
  /**
...
class ReactNativePaymentsAdapter {
  ...
  createPaymentRequest(paymentDetails, methodConfig) {
    ...
    return new reactNativePayments.PaymentRequest(methodData, {
...
class ApplePayAdapter {
  ...
  async canMakePayments() {
    try {
      ...
      const paymentRequest = new reactNativePayments.PaymentRequest(testMethodData, testDetails);
  ...
  async showPaymentSheet(paymentDetails) {
    ...
    try {
      ...
      const paymentRequest = new reactNativePayments.PaymentRequest(methodData, details);
...
function useTunaPayments(config) {
  const [tunaSDK, setTunaSDK] = react.useState(null);
   ...
   */
  const initialize = react.useCallback(async initConfig => {
   ...
   */
  const processPayment = react.useCallback(async paymentDetails => {
    ...
    try {
      ...
      if (reactNative.Platform.OS === 'ios' && (await tunaSDK.canMakeApplePayPayments())) {
      ...
      } else if (reactNative.Platform.OS === 'android' && (await tunaSDK.isGooglePayReady())) {
...
function useApplePay(tunaSDK) {
  const [applePayState, setApplePayState] = react.useState({
    isAvailable: false,
    isConfigured: false,
    isLoading: false,
    error: null
  ...
  const checkAvailability = react.useCallback(async () => {
    if (reactNative.Platform.OS !== 'ios' || !(tunaSDK === null || tunaSDK === void 0 ? void 0 : tunaSDK.isReady())) {
   ...
   * Setup Apple Pay configuration
   */
  const setupApplePay = react.useCallback(async config => {
    if (!tunaSDK) {
   ...
   * Show Apple Pay payment sheet
   */
  const showPaymentSheet = react.useCallback(async paymentDetails => {
    if (!tunaSDK) {
      const error = new TunaPaymentError('SDK not available');
      setApplePayState(prev => ({
        ...prev,
...
function useGooglePay(tunaSDK) {
  const [googlePayState, setGooglePayState] = react.useState({
    isAvailable: false,
    isConfigured: false,
    isLoading: false,
    error: null
   ...
   */
  const checkAvailability = react.useCallback(async () => {
    if (reactNative.Platform.OS !== 'android' || !(tunaSDK === null || tunaSDK === void 0 ? void 0 : tunaSDK.isReady())) {
   ...
   * Setup Google Pay configuration
   */
  const setupGooglePay = react.useCallback(async config => {
    if (!tunaSDK) {
      const error = new TunaPaymentError('SDK not available');
      setGooglePayState(prev => ({
        ...prev,
...
function usePIXPayments(tunaSDK) {
  const [pixState, setPixState] = react.useState({
    isLoading: false,
    qrCode: null,
    qrCodeImage: null,
    expirationTime: null,
   ...
   */
  const generatePIXPayment = react.useCallback(async (amount, customer) => {
    if (!(tunaSDK === null || tunaSDK === void 0 ? void 0 : tunaSDK.isReady())) {
   ...
   */
  const clearPIXPayment = react.useCallback(() => {
    setPixState({
      isLoading: false,
      qrCode: null,
      qrCodeImage: null,
...
exports.AntifraudManager = AntifraudManager;
exports.ApplePayAdapter = ApplePayAdapter;
exports.BrazilianDocumentValidator = BrazilianDocumentValidator;
...
exports.ReactNativePaymentsAdapter = ReactNativePaymentsAdapter;
exports.SessionManager = SessionManager;
exports.StatusPoller = StatusPoller;
exports.ThreeDSHandler = ThreeDSHandler;
exports.TokenizationManager = TokenizationManager;
exports.Tuna3DSError = Tuna3DSError;
exports.TunaError = TunaError;
exports.TunaErrorCodes = TunaErrorCodes;
exports.TunaNativePaymentError = TunaNativePaymentError;
exports.TunaNetworkError = TunaNetworkError;
exports.TunaPaymentError = TunaPaymentError;
exports.TunaReactNative = TunaReactNative;
exports.TunaSessionError = TunaSessionError;
exports.TunaTokenizationError = TunaTokenizationError;
exports.TunaValidationError = TunaValidationError;
exports.capitalizeWords = capitalizeWords;
exports.cleanString = cleanString;
exports.createAntifraudManager = createAntifraudManager;
exports.createApplePayAdapter = createApplePayAdapter;
exports.createGooglePayAdapter = createGooglePayAdapter;
exports.createStatusPoller = createStatusPoller;
exports.createThreeDSHandler = createThreeDSHandler;
exports.createTimeoutPromise = createTimeoutPromise;
exports.createTunaError = createTunaError;
exports.createTunaReactNative = createTunaReactNative;
exports.default = TunaReactNative;
exports.formatCNPJ = formatCNPJ;
exports.formatCPF = formatCPF;
exports.formatCardExpiration = formatCardExpiration;
exports.formatCreditCardDisplay = formatCreditCardDisplay;
...
exports.isTunaError = isTunaError;
...
exports.usePIXPayments = usePIXPayments;
exports.useTunaComplete = useTunaComplete;
exports.useTunaPayments = useTunaPayments;
