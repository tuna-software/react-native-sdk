 ...
 * Supports Apple Pay, Google Pay, credit cards, PIX, Boleto, and other payment methods.
 *
 * This is the main entry point for the Tuna React Native SDK, orchestrating all
 * the underlying components (SessionManager, TokenizationManager, PaymentManager, etc.)
...
import type { ApplePayConfig, GooglePayConfig, PaymentDetails, PaymentResult, ApplePayResult, GooglePayResult, CardData, TokenResult, SavedCard, BindResult, DeleteResult, StatusResult, PIXResult, BoletoResult, CustomerInfo, AntifraudConfig, StatusPollingConfig, StatusCallback, PaymentRequest, Environment } from './types/payment';
/**
...
export declare class TunaReactNative {
    ...
    /**
     * Initiate Boleto payment
     */
    initiateBoletoPayment(amount: number, customer: CustomerInfo): Promise<BoletoResult>;
    /**
...
//# sourceMappingURL=TunaReactNative.d.ts.map